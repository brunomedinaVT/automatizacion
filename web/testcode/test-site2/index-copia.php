...
<html>
  <head>
	...
	<link rel="stylesheet" href="styles/style1-copia.css">
  ...
  <body>					<!-- contiene todo el contenido que se dedea mostrar -->
	...
	<table style="text-align: center;" border="3" id="tabla1";>
		<tr>
	...
	<a href="/testcode/test-site2/Informe/Informe.php" target="_blank"><button id="Boton">Generar Informe</button></a>
     </div>
  	...
  	<script>
		...
		type:"bar",
		data:{
			labels:['FALTA PIEZA','FALLA PIEZA','OTROS'],
			datasets:[{	
