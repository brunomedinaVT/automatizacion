...
date_default_timezone_set ("America/Argentina/Buenos_Aires"); //define zona horaria del servidor

//ESTADO DE LA LINEA
    $lineaMarcha = "Linea Marcha";      
    $lineaParada = "Linea Detenida"; //declara variables
...
//consulta ultimo estado de la tabla
